...
func schema_pkg_apis_softwarecomposition_v1beta1_GeneratedNetworkPolicySpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"status": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/kubescape/storage/pkg/apis/softwarecomposition/v1beta1.NetworkPolicyStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/kubescape/storage/pkg/apis/softwarecomposition/v1beta1.NetworkPolicySpec", "github.com/kubescape/storage/pkg/apis/softwarecomposition/v1beta1.NetworkPolicyStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_softwarecomposition_v1beta1_NetworkPolicyPort(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"port": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/kubescape/storage/pkg/apis/softwarecomposition/v1beta1.IntOrString"),
						},
					},
					"endPort": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubescape/storage/pkg/apis/softwarecomposition/v1beta1.IntOrString"},
	}
}
