	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SpdxV1beta1().Rules(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SpdxV1beta1().Rules(namespace).Watch(context.TODO(), options)
			},
		},
		&softwarecompositionv1beta1.Rule{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *ruleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&softwarecompositionv1beta1.Rule{}, f.defaultInformer)
}

func (f *ruleInformer) Lister() v1beta1.RuleLister {
	return v1beta1.NewRuleLister(f.Informer().GetIndexer())
}
