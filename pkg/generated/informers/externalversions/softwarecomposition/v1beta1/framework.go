...
type FrameworkInformer interface {
	...
	Lister() v1beta1.FrameworkLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SpdxV1beta1().Frameworks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SpdxV1beta1().Frameworks(namespace).Watch(context.TODO(), options)
			},
		},
		&softwarecompositionv1beta1.Framework{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *frameworkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&softwarecompositionv1beta1.Framework{}, f.defaultInformer)
}

func (f *frameworkInformer) Lister() v1beta1.FrameworkLister {
	return v1beta1.NewFrameworkLister(f.Informer().GetIndexer())
}
