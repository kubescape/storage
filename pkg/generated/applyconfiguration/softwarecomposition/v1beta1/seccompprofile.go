...
// SeccompProfile constructs a declarative configuration of the SeccompProfile type for use with
// apply.
func SeccompProfile(name, namespace string) *SeccompProfileApplyConfiguration {
	b := &SeccompProfileApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("SeccompProfile")
...
func (b *SeccompProfileApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
...
func (b *SeccompProfileApplyConfiguration) GetKind() *string {
