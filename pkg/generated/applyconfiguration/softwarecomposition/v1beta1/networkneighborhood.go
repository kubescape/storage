...
// NetworkNeighborhood constructs a declarative configuration of the NetworkNeighborhood type for use with
// apply.
func NetworkNeighborhood(name, namespace string) *NetworkNeighborhoodApplyConfiguration {
	b := &NetworkNeighborhoodApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("NetworkNeighborhood")
...
func (b *NetworkNeighborhoodApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
...
func (b *NetworkNeighborhoodApplyConfiguration) GetKind() *string {
