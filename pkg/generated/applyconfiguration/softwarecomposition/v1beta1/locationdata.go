...
// LocationDataApplyConfiguration constructs a declarative configuration of the LocationData type for use with
// apply.
func LocationData() *LocationDataApplyConfiguration {
	return &LocationDataApplyConfiguration{}
}

// WithVirtualPath sets the VirtualPath field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the VirtualPath field is set to the value of the last call.
