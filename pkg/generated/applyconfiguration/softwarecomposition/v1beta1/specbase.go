...
// SpecBaseApplyConfiguration represents a declarative configuration of the SpecBase type for use
// with apply.
type SpecBaseApplyConfiguration struct {
	Disabled *bool `json:"disabled,omitempty"`
}

// SpecBaseApplyConfiguration constructs a declarative configuration of the SpecBase type for use with
// apply.
func SpecBase() *SpecBaseApplyConfiguration {
	return &SpecBaseApplyConfiguration{}
}
