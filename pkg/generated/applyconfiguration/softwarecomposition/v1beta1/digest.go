...
// DigestApplyConfiguration represents a declarative configuration of the Digest type for use
// with apply.
...
// DigestApplyConfiguration constructs a declarative configuration of the Digest type for use with
// apply.
func Digest() *DigestApplyConfiguration {
	return &DigestApplyConfiguration{}
}
