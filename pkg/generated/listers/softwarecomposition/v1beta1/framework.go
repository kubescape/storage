...
type FrameworkLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.Framework, err error)
...
// List lists all Frameworks in the indexer.
func (s *frameworkLister) List(selector labels.Selector) (ret []*v1beta1.Framework, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.Framework))
	})
	return ret, err
}
...
type FrameworkNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1beta1.Framework, error)
...
// List lists all Frameworks in the indexer for a given namespace.
func (s frameworkNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.Framework, err error) {
...
// Get retrieves the Framework from the indexer for a given namespace and name.
func (s frameworkNamespaceLister) Get(name string) (*v1beta1.Framework, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("framework"), name)
	}
	return obj.(*v1beta1.Framework), nil
}
