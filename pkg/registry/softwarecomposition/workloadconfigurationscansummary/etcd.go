...
func NewREST(scheme *runtime.Scheme, storageImpl storage.Interface, optsGetter generic.RESTOptionsGetter) (*registry.REST, error) {
	...
	store := &genericregistry.Store{
		...
		DefaultQualifiedResource:  softwarecomposition.Resource("workloadconfigurationscansummaries"),
		...
		TableConvertor: rest.NewDefaultTableConvertor(softwarecomposition.Resource("workloadconfigurationscansummaries")),
	}
