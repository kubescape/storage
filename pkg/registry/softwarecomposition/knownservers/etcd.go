...
func NewREST(scheme *runtime.Scheme, storageImpl storage.Interface, optsGetter generic.RESTOptionsGetter) (*registry.REST, error) {
	...
	store := &genericregistry.Store{
		...
		DefaultQualifiedResource:  softwarecomposition.Resource("knownservers"),
		...
		TableConvertor: rest.NewDefaultTableConvertor(softwarecomposition.Resource("knownservers")),
	}
