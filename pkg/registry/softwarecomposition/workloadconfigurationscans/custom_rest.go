...
// pkg/registry/genericrest/store.go) with workloadconfigurationscans-specific
...
// custom_rest_test.go). Namespaced, no-op Strategy. Not inverted:
...
// workloadconfigurationscans. Its signature intentionally matches NewREST's
// so it can be wired in as a drop-in alternative in
...
func NewCustomREST(scheme *runtime.Scheme, storageImpl storage.Interface, optsGetter generic.RESTOptionsGetter) (*CustomREST, error) {
	...
	qualifiedResource := softwarecomposition.Resource("workloadconfigurationscans")
	singularQualifiedResource := softwarecomposition.Resource("workloadconfigurationscan")

	return genericrest.NewStore(storageImpl, optsGetter, genericrest.Store{
		NewFunc:                   func() runtime.Object { return &softwarecomposition.WorkloadConfigurationScan{} },
		NewListFunc:               func() runtime.Object { return &softwarecomposition.WorkloadConfigurationScanList{} },
