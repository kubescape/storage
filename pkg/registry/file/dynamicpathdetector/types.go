...
// across a group — the whole set of network neighbors is separately capped by
// the container profile size limit); it only bites when a held pass-through block is
