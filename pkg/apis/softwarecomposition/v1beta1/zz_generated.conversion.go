...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*StackTrace)(nil), (*softwarecomposition.StackTrace)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_StackTrace_To_softwarecomposition_StackTrace(a.(*StackTrace), b.(*softwarecomposition.StackTrace), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*softwarecomposition.StackTrace)(nil), (*StackTrace)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_softwarecomposition_StackTrace_To_v1beta1_StackTrace(a.(*softwarecomposition.StackTrace), b.(*StackTrace), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_ExecCalls_To_softwarecomposition_ExecCalls(in *ExecCalls, out *softwarecomposition.ExecCalls, s conversion.Scope) error {
	...
	if err := Convert_v1beta1_StackTrace_To_softwarecomposition_StackTrace(&in.ProcessTree, &out.ProcessTree, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_softwarecomposition_ExecCalls_To_v1beta1_ExecCalls(in *softwarecomposition.ExecCalls, out *ExecCalls, s conversion.Scope) error {
	...
	out.Args = *(*[]string)(unsafe.Pointer(&in.Args))
	out.Envs = *(*[]string)(unsafe.Pointer(&in.Envs))
	if err := Convert_softwarecomposition_StackTrace_To_v1beta1_StackTrace(&in.ProcessTree, &out.ProcessTree, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1beta1_StackFrame_To_softwarecomposition_StackFrame(in *StackFrame, out *softwarecomposition.StackFrame, s conversion.Scope) error {
	out.File = softwarecomposition.FileName(in.File)
	out.Address = in.Address
	out.Children = *(*[]softwarecomposition.FileName)(unsafe.Pointer(&in.Children))
	out.Parents = *(*[]softwarecomposition.FileName)(unsafe.Pointer(&in.Parents))
	return nil
}
...
func autoConvert_softwarecomposition_StackFrame_To_v1beta1_StackFrame(in *softwarecomposition.StackFrame, out *StackFrame, s conversion.Scope) error {
	out.File = FileName(in.File)
	out.Address = in.Address
	out.Children = *(*[]FileName)(unsafe.Pointer(&in.Children))
	out.Parents = *(*[]FileName)(unsafe.Pointer(&in.Parents))
	return nil
}
...
func autoConvert_v1beta1_StackTrace_To_softwarecomposition_StackTrace(in *StackTrace, out *softwarecomposition.StackTrace, s conversion.Scope) error {
	out.Root = softwarecomposition.FileName(in.Root)
	out.Nodes = *(*map[softwarecomposition.FileName]softwarecomposition.StackFrame)(unsafe.Pointer(&in.Nodes))
	return nil
}

// Convert_v1beta1_StackTrace_To_softwarecomposition_StackTrace is an autogenerated conversion function.
func Convert_v1beta1_StackTrace_To_softwarecomposition_StackTrace(in *StackTrace, out *softwarecomposition.StackTrace, s conversion.Scope) error {
	return autoConvert_v1beta1_StackTrace_To_softwarecomposition_StackTrace(in, out, s)
}

func autoConvert_softwarecomposition_StackTrace_To_v1beta1_StackTrace(in *softwarecomposition.StackTrace, out *StackTrace, s conversion.Scope) error {
	out.Root = FileName(in.Root)
	out.Nodes = *(*map[FileName]StackFrame)(unsafe.Pointer(&in.Nodes))
	return nil
}

// Convert_softwarecomposition_StackTrace_To_v1beta1_StackTrace is an autogenerated conversion function.
func Convert_softwarecomposition_StackTrace_To_v1beta1_StackTrace(in *softwarecomposition.StackTrace, out *StackTrace, s conversion.Scope) error {
	return autoConvert_softwarecomposition_StackTrace_To_v1beta1_StackTrace(in, out, s)
}
